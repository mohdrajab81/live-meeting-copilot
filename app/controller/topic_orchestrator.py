    ...
    async def run_update(self, topic_call: dict[str, Any]) -> None:
        ...
        try:
            ...
            with self._lock:
                ...
                allocated_seconds_by_key, allocation_basis, unassigned_seconds = (
                ...
                self._append_run_unlocked(
                    {
                        ...
                        "dropped_custom_disabled": dropped_custom_disabled,
                        "dropped_invalid_name": dropped_invalid_name,
                        "allow_new_topics": self.topics_allow_new,
                        "chunk_mode": self.topics_chunk_mode,
                        "returned_topics": len(items_raw),
                        "normalized_topics": len(normalized),
                        "stored_topics": len(self.topics_items),
                ...
                self._append_run_unlocked(
                    {
                        ...
                        "gap_seconds": ctx["gap_seconds"],
                        "possible_context_reset": ctx["possible_context_reset"],
                        "allocation_basis": "error",
                        "unassigned_seconds": ctx["chunk_seconds"],
                        "allow_new_topics": self.topics_allow_new,
                        "chunk_mode": self.topics_chunk_mode,
                        "returned_topics": 0,
                        "normalized_topics": 0,
